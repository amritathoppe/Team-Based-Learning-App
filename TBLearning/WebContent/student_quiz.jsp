...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  <script>
var pos = 0, test, test_status, question, choices, choice, chA, chB, chC, correct = 0, count =0;
var questions =[
...
function renderQuestion(){
	...
	test.innerHTML += "<button id='submitBtn' class='modelBtn' onclick='checkAnswer(count)'>Submit Answer</button>";
...
function checkAnswer(count){
	...
	if(choice == questions[pos][4]){
		...
		count= count + 1
		$("#alert").append("<span id='alertContent'><h2>You choosed the wrong one and you have "+ count +" chances more </h2></span>");
